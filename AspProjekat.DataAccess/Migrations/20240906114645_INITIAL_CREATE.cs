    ...
    public partial class INITIAL_CREATE : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projections_ProjectionTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProjectionsId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectionUser", x => new { x.ProjectionsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ProjectionUser_Projections_ProjectionsId",
                        column: x => x.ProjectionsId,
                        principalTable: "Projections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectionUser_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projections_TypeId",
                table: "Projections",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectionUser_UsersId",
                table: "ProjectionUser",
                column: "UsersId");
